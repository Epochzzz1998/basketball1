...
public class PlayerStatsServiceImpl extends ServiceImpl<PlayerStatsMapper, PlayerStats> implements PlayerStatsService {
    ...
    private void recomputeCareerSummary(String playerId) {
        ...
        double playerAvgFgm = 0.0;
        double playerAvgFga = 0.0;
        double playerAvgTpm = 0.0;
        double playerAvgTpa = 0.0;
        double playerAvgFtm = 0.0;
        double playerAvgFta = 0.0;
        double playerAvgOffReb = 0.0;
        double playerAvgDefReb = 0.0;
        ...
        for (PlayerStatsDto dto : rows) {
            ...
            playerAvgFgm += StatsMath.nz(dto.getPlayerAvgFgm()) * appearance;
            playerAvgFga += StatsMath.nz(dto.getPlayerAvgFga()) * appearance;
            playerAvgTpm += StatsMath.nz(dto.getPlayerAvgTpm()) * appearance;
            playerAvgTpa += StatsMath.nz(dto.getPlayerAvgTpa()) * appearance;
            playerAvgFtm += StatsMath.nz(dto.getPlayerAvgFtm()) * appearance;
            playerAvgFta += StatsMath.nz(dto.getPlayerAvgFta()) * appearance;
            playerAvgOffReb += StatsMath.nz(dto.getPlayerAvgOffReb()) * appearance;
            playerAvgDefReb += StatsMath.nz(dto.getPlayerAvgDefReb()) * appearance;
        ...
        summary.setPlayerAvgFgm(StatsMath.avg(playerAvgFgm, playerAppearance, 1));
        summary.setPlayerAvgFga(StatsMath.avg(playerAvgFga, playerAppearance, 1));
        summary.setPlayerAvgTpm(StatsMath.avg(playerAvgTpm, playerAppearance, 1));
        summary.setPlayerAvgTpa(StatsMath.avg(playerAvgTpa, playerAppearance, 1));
        summary.setPlayerAvgFtm(StatsMath.avg(playerAvgFtm, playerAppearance, 1));
        summary.setPlayerAvgFta(StatsMath.avg(playerAvgFta, playerAppearance, 1));
        summary.setPlayerAvgOffReb(StatsMath.avg(playerAvgOffReb, playerAppearance, 1));
        summary.setPlayerAvgDefReb(StatsMath.avg(playerAvgDefReb, playerAppearance, 1));
