        ...
        <div class="layui-form-item" style="margin-top: 15px">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-block">
                    <input type="text" name="title" id="title" value="${(news.title)!}" required  lay-verify="required" placeholder="新闻标题" autocomplete="off" class="layui-input" style="width: 500px">
                </div>
            </div>
            <div class="layui-inline">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <select name="team" id="team" lay-verify="required">
