...
export function buildFullStatColumns({ serverSort = true } = {}) {
  ...
  return [
    ...
    { title: 'PER', dataIndex: 'playerPer', width: 58, ...srt, render: (v) => num(v) },
    { title: 'PIE', dataIndex: 'playerPie', width: 58, ...srt, render: (v) => num(v) },
    { title: 'WS', dataIndex: 'playerWs', width: 56, ...srt, render: (v) => num(v) },
    { title: '进攻效率', dataIndex: 'playerOffEff', width: 76, ...srt, render: (v) => num(v) },
    { title: '防守效率', dataIndex: 'playerDefEff', width: 76, ...srt, render: (v) => num(v) },
    { title: '净效率', dataIndex: 'playerNetEff', width: 68, ...srt, render: (v) => num(v) },
    { title: '正负值', dataIndex: 'playerAvgPn', width: 68, ...srt, render: (v) => num(v) },
